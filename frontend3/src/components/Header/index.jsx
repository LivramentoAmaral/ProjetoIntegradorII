    ...
    const handleLogout = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // Lógica para realizar o logout, como limpar o token do localStorage, etc.
