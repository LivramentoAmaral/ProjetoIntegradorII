  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        script.onload = () => {
          window.Chatbot.init({
            chatflowid: 'c4952c79-6dbb-4cb8-820e-deca0d4b0ae3',
            ...
            theme: {
              ...
              chatWindow: {
                welcomeMessage: 'Olá seja bem-vindo chatbot aqui você pode pedir informações sobre a plataforma e de desrições simples ?',
